...
export function SupplierModelConfigPanel({ v2, tokenPrices, onSaved, onError }: {
  ...
  if (v2.v2_error) return <section className="card settings-section"><h2>Supplier Model Config</h2><p className="error">{`V2 config load failed: ${v2.v2_error}`}</p></section>;
